...
We strongly recommend using [**Ivy**](/docs/ivy/installation), the official command library for Pedro Pathing,
...
states manually. To learn more about Ivy, check out the [Ivy documentation](/docs/ivy/installation).
